...
const RegistroUsuario = () => {
  ...
  const handleSubmit = (e) => {
    ...
    registerUser(name.value, lastname.value, email.value, password.value, cpassword.value, birthdate.value, gender.value, province.value, kidegoa.value, etapa.value, privacyValue, infoValue); 
  };

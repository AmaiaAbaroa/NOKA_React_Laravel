  ...
  return (
    <>
      ...
      <main className="landingpage_main">
        ...
        <CardAccordionAtom color_article={"grey_article"} card_id_identifier={"2"}  card_number_identifier={"2"} accordion_title={"EMAITZAK"} accordion_body={"Heme formulario bat joan beharko litzateke"}></CardAccordionAtom>
      </main>
